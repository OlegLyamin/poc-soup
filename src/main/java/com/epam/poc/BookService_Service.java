 ...
 * 2021-04-29T17:43:42.658+03:00
 * Generated source version: 3.4.3
 *
 */
@WebServiceClient(name = "BookService",
                  wsdlLocation = "file:/D:/projects/poc/poc/src/main/resources/wsdl/helloworld.wsdl",
                  targetNamespace = "http://www.olegbook.com/BookService/")
public class BookService_Service extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://www.olegbook.com/BookService/", "BookService");
    public final static QName BookServiceSOAP = new QName("http://www.olegbook.com/BookService/", "BookServiceSOAP");
    static {
        URL url = null;
        try {
            url = new URL("file:/D:/projects/poc/poc/src/main/resources/wsdl/helloworld.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(BookService_Service.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/D:/projects/poc/poc/src/main/resources/wsdl/helloworld.wsdl");
        }
        WSDL_LOCATION = url;
    }
